		...
		<form role="form" method="GET" action="<%=url%>PacienteController?">
			...
			<div class="form-group row mb-4">
			    <div class="col-md-6 d-flex align-items-center gap-3">
			        <input type="hidden" name="op" id="op" value="buscarpaciente" />
			        <input class="form-control mb-0 mr-2" type="text" id="dni" name="dni" placeholder="Ingrese DNI">
			        <input class="btn btn-info" type="submit" name="buscar" value="Buscar" onclick="document.getElementById('op').value = 'buscarpaciente';">
			    </div>
