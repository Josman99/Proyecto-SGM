...
INSERT INTO `cita` VALUES (1,'2025-01-15',3,15,'2025-01-13'),(2,'2025-01-15',3,1,'2025-01-13'),(3,'2025-01-15',3,49,'2025-06-16'),(4,'2025-01-15',3,50,'2025-06-16'),(5,'2025-01-15',4,51,'2025-06-16');
...
INSERT INTO `horario` VALUES (1,1,'2025-01-13','08:00:00','12:00:00',12,10),(2,2,'2025-01-13','08:00:00','12:00:00',12,11),(3,3,'2025-01-13','14:00:00','18:00:00',12,12),(4,4,'2025-06-12','14:00:00','18:00:00',12,12),(5,8,'2025-06-16','14:00:00','18:00:00',12,9);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listarHorario`(in id int)
BEGIN

select id_intervalos,concat(hora_ini,' ',hora_fin) AS Horario from intervalos
...
select id_intervalos,id_horario,concat(hora_ini," ",hora_fin) as Hora  from intervalos where id_horario=id;
...
-- Dump completed on 2025-01-15  3:02:44
