...
INSERT INTO `horario` VALUES (1,1,'2025-01-13','08:00:00','12:00:00',12,11),(2,2,'2025-01-13','08:00:00','12:00:00',12,12),(3,3,'2025-01-13','14:00:00','18:00:00',12,12),(4,4,'2025-06-12','14:00:00','18:00:00',12,12);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_insertarCita`(in idpaciente int, in idhora int,in fecha date,in edad int )
BEGIN

insert into cita(id_cita,id_Paciente,id_horario,fecha_creacion,edad) values(0,idpaciente,idhora,fecha,edad);
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `sp_listarCita`(in id int)
BEGIN
...
-- Dump completed on 2025-01-13 21:26:32
